  ...
  return (
    ...
    <div className="auth-wrapper">
      ...
      <div className="smt">
       ...
       <p>เปิดประสบการณ์ Meat Avatar "อาหารทางเลือกใหม่" ของกลุ่มคนรักสุขภาพและผู้ที่ทานเจ ผลิตภัณฑ์แปลรูปที่ทําจากพืชให้ออกมาเปรียบเสมือนเนื้อสัตว์จริงๆ สู่ความคุ้มค่าจากทุกการจ่าย เพิ่มความสะดวกแบบไร้ขีดจํากัด พร้อมรับสิทธิพิเศษและเมนูโปรดฟรี</p>
       ...
       <div className="smttext">
       <p>สิทธิประโยชน์มากมาย หากคุณเข้ามาเป็นส่วนหนึ่งของเรา Meat Avatar Member เราพร้อมที่จะมอบความสุข ความสนุกในการใช้จ่ายของคุณ</p>
